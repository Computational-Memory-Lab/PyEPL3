...
def mathDistract2(clk = None,
    ...
    #                     continue
                ...
                # update the text
                if isInputDone:
#                   rt = v.replace(rt,Text(rstr,size = textSize, color="green"))
                    rt = v.replace(rt,Text(rstr,size = textSize, color='#777777'))
#                   rt = v.replace(rt,Text(rstr,size = textSize, color='darkgrey'))
                else:
